...
mode_implicitly_wait_time = 0.3
normal_time_sleep = 2
mode_time_sleep = 0.5

account = input("請輸入Google帳號:")
psword = input("請輸入Google密碼:")
...
while True:
    ...
    if mode == '0':
        ...
        driver.implicitly_wait(mode_implicitly_wait_time)
        restaurants = driver.find_elements(By.XPATH,'//div[@class="m6QErb DxyBCb kA9KIf dS8AEf XiKgde ussYcc "]/div[@class="m6QErb XiKgde "]')
